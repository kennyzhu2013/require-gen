...
func (tc *ToolChecker) CheckTool(tool string, tracker *ui.StepTracker) bool {
	// 检查工具是否在PATH中
...
func (tc *ToolChecker) CheckAllTools(tools []string, tracker *ui.StepTracker) bool {
	allAvailable := true
...
func (tc *ToolChecker) getInstallSuggestion(tool string) string {
	...
	case "gemini":
		return "Install Gemini CLI: https://ai.google.dev/gemini-api/docs/cli"
